...
//import static com.google.firebase.udacity.friendlychat.Sign_in.email;
...
//        final String computerEngineeringArray[] = new String[]{"3C1", "3C2", "3D1", "3D2", "3D5B", "3D3", "3D4", "3D5A", "CS2022"};

//        for(int i = 0; i< 9; i++) {
//            modules.add(computerEngineeringArray[i]);
//        }
